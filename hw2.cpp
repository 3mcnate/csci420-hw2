...
void initScene(int argc, char *argv[])
{
  ...
  *****************************************************************/
  ...
  Point p1(length, -length, length);
  Point p2(length, -length, -length);
  Point p3(-length, -length, -length);
  Point p4(-length, -length, length);

  addPointToVector(p1, groundVertices);
  addPointToVector(p2, groundVertices);
  addPointToVector(p3, groundVertices);
  addPointToVector(p4, groundVertices);

  addUVPointToVector(1, 1, groundUVMap);
  addUVPointToVector(1, 0, groundUVMap);
  addUVPointToVector(0, 0, groundUVMap);
  addUVPointToVector(0, 1, groundUVMap);
